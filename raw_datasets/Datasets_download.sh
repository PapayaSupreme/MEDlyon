...
# /!\ This file downloads everything to the pwd.
...
#curl -fsSL "https://drive.usercontent.google.com/download?id=1GjWrIZq_mx8Ugpxrm-_yzzbXzMhZ3FAk" > Agency.txt
#curl -fsSL "https://drive.usercontent.google.com/download?id=1EXi_fUcYtKaUYJA5NIuoTMbljo9Hq2YH" > 'Calendar dates.txt'
curl -fsSL "https://drive.usercontent.google.com/download?id=1y1JWkDTyFtSttHzhAsDBwhIqMWeYFHSY" > trips.txt
#curl -fsSL "https://drive.usercontent.google.com/download?id=1R-EA9Wr58JmG1to4r9OX8IP73Fi9BlA7" > calendar.txt
#curl -fsSL "https://drive.usercontent.google.com/download?id=1j0L2ZQIysFtpHXmDMVNxKvl5ksljOz_C" > fare_attributes.txt
#curl -fsSL "https://drive.usercontent.google.com/download?id=1X8zInfwPeClbLZO_AUmc6cIe-0vZuTzv" > fare_rules.txt
#curl -fsSL "https://drive.usercontent.google.com/download?id=1QGA8kJyxtTpX1DT091M4z8KlZDfA8y5s" > feed_info.txt
#curl -fsSL "https://drive.usercontent.google.com/download?id=1X9FnWRx7knyiztP-GKDUa_FMifSUN-3k" > frequencies.txt
