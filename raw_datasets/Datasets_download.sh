...
#curl -L "https://drive.usercontent.google.com/download?id=1GjWrIZq_mx8Ugpxrm-_yzzbXzMhZ3FAk" -o 'raw_datasets/bus/lyon_tcl/Agency.txt' --create-dirs
#curl -L "https://drive.usercontent.google.com/download?id=1EXi_fUcYtKaUYJA5NIuoTMbljo9Hq2YH" -o 'raw_datasets/bus/lyon_tcl/Calendar dates.txt'
curl -L "https://drive.usercontent.google.com/download?id=1y1JWkDTyFtSttHzhAsDBwhIqMWeYFHSY" -o 'raw_datasets/bus/lyon_tcl/trips.txt' --create-dirs
#curl -L "https://drive.usercontent.google.com/download?id=1R-EA9Wr58JmG1to4r9OX8IP73Fi9BlA7" -o 'raw_datasets/bus/lyon_tcl/calendar.txt'
#curl -L "https://drive.usercontent.google.com/download?id=1j0L2ZQIysFtpHXmDMVNxKvl5ksljOz_C" -o 'raw_datasets/bus/lyon_tcl/fare_attributes.txt'
#curl -L "https://drive.usercontent.google.com/download?id=1X8zInfwPeClbLZO_AUmc6cIe-0vZuTzv" -o 'raw_datasets/bus/lyon_tcl/fare_rules.txt'
#curl -L "https://drive.usercontent.google.com/download?id=1QGA8kJyxtTpX1DT091M4z8KlZDfA8y5s" -o 'raw_datasets/bus/lyon_tcl/feed_info.txt'
#curl -L "https://drive.usercontent.google.com/download?id=1X9FnWRx7knyiztP-GKDUa_FMifSUN-3k" -o 'raw_datasets/bus/lyon_tcl/frequencies.txt'
#curl -L "https://drive.usercontent.google.com/download?id=105SVONlU-kcgqYUv50jlnYftTyzkS6vU" -o 'raw_datasets/bus/lyon_tcl/id_mappings.txt'
#curl -L "https://drive.usercontent.google.com/download?id=1uFlgr0VIMATCc2n2K3p074WLCIpbFUDG" -o 'raw_datasets/bus/lyon_tcl/routes.txt'
#curl -L "https://drive.usercontent.google.com/download?id=14ZFanoyzm6VtNT6y6B0M8F_9HVY1ryDA&confirm" -o 'raw_datasets/bus/lyon_tcl/shapes.txt' #(/!\ TOO BIG CANNOT DIRECTLY DOWNLOAD)
curl -L "https://drive.usercontent.google.com/download?id=1MSZ9l3ur_IjNrx4iom7Af4dMLvhgbG7p&confirm" -o 'raw_datasets/bus/lyon_tcl/Stop_times.txt' #Too big to download normally so we add &confirm to bypass the confirmation screen
curl -L "https://drive.usercontent.google.com/download?id=1SWU4ytmigCsoPYn2juqbQ_d29NKATu19" -o 'raw_datasets/bus/lyon_tcl/stops.txt'
#curl -L "https://drive.usercontent.google.com/download?id=1Fy8Ip9c57B5M1SOwDNfe1l2EUmkd2Wwm" -o 'raw_datasets/bus/lyon_tcl/transfers.txt'
...
curl -L "https://drive.usercontent.google.com/download?id=15gYhnrVg9B7p1QEf143FMG0-8Ieb2ieb" -o 'raw_datasets/metro/horaires_tcl.csv' --create-dirs
